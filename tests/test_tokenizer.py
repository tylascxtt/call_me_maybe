...
def test_ascii_and_space_decoding(
    tmp_path: Path,
) -> None:
    """ASCII and space tokens decode correctly."""
    # Byte-level BPE stores a space as "Ġ"; ASCII characters map directly.
    vocab = Vocabulary(
        _write_vocab(
            tmp_path,
            {
...
def test_decode_round_trip(
    ...
    """Decoded tokens reconstruct the expected string."""
    vocab = Vocabulary(
        _write_vocab(
            tmp_path,
            {
